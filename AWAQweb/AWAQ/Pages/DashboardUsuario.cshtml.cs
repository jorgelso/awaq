...
{
    public class DashboardUsuarioModel : PageModel
    {
        private readonly IConfiguration _configuration;

        public DashboardUsuarioModel(IConfiguration configuration)
        {
        ...
        [BindProperty]
        public string blurCSS { get; set; }

        [BindProperty]
        public string blurCSS2 { get; set; }
        ...
        public IList<string> biomas { get; set; }
        ...
        public IActionResult OnGet()
        {
            ...
            id_usuario = Convert.ToInt32(HttpContext.Session.GetString("id"));
            id_usuarioSeleccionado = Convert.ToInt32(HttpContext.Session.GetString("id"));
            ...
            cmd6.CommandText = "SELECT tiempo_jugado AS total_tiempo FROM usuario WHERE id_usuario = @id_usuario";
            ...
            cmd9.CommandText = "select count(*) from animal;";
            object result4 = cmd9.ExecuteScalar();
